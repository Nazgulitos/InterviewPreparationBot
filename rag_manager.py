...
from modules.questions_generator import create_questions_by_theme
...
class RAGManager:
    ...
    async def get_questions_by_theme(self, theme, n_results):
        # Retrieve questions related to the given theme using embeddings or any other logic
        return await create_questions_by_theme(theme, self.chromadb, n_questions=n_results)

    async def get_questions_by_level(self, theme, level, n_results):
